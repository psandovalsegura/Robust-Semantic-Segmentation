...
#SBATCH --job-name=test-advprop-voc
...
# Usage:
#   sbatch scripts/test_voc.sh config/paper/voc2012/voc2012_pspnet50.yaml train_sat_psp
...
cp scripts/test_voc_psp.sh tool_test/voc2012/test_voc_psp.py $1 ${EXPERIMENT_DIR}
...
python ${EXPERIMENT_DIR}/test_voc_psp.py --config=${EXPERIMENT_DIR}/$(basename $1) experiment_name ${EXPERIMENT_NAME} workers 2
