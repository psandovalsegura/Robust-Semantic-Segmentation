...
cp scripts/train_city_psp.sh tool_train/${EXPERIMENT_NAME}.py tool_test/cityscapes/test_city_psp.py $1 ${EXPERIMENT_DIR}
...
python ${EXPERIMENT_DIR}/test_city_psp.py --config=${EXPERIMENT_DIR}/$(basename $1) experiment_name ${EXPERIMENT_NAME}
