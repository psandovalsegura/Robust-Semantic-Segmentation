...
#SBATCH --dependency=afterok:20679:19949
...
declare -a EXP_NAMES=('train_psp' 'train_sat_psp' 'train_ddcat_psp' 'train_advprop_psp')
...
cp tool_test/cityscapes/test_city_psp.py $1 ${EXPERIMENT_DIR}
python ${EXPERIMENT_DIR}/test_city_psp.py --config=${EXPERIMENT_DIR}/$(basename $1) experiment_name ${EXP_NAME} workers 2 has_prediction True
